...
FocusAR is a Flutter focus timer for Android and iPhone. It uses ARCore/ARKit to anchor a phone-sized focus zone on a desk, then uses the accelerometer and gyroscope to make sure the device stays face-down until the timer ends.

## Flow

1. Choose 25, 45, 60, or 90 minutes.
2. Scan a flat surface and tap to place the blue AR focus zone.
3. Put the phone face-down inside the zone. The timer starts after the phone is still for 1.2 seconds.
4. Lifting or tilting the phone pauses the timer and starts a repeating sound/haptic warning.
